...
if __name__ == '__main__':
    ...
    for j in range(2,10):
        ...
        for i in range(2,12):
            ...
            parser.add_argument('--data-path', default=r'./RBC_Dataset/active_learning0'+str(j)+'/randomchoose', help='Path to dataset')
            parser.add_argument('--weights', default='./RBC_Dataset/active_learning0'+str(j)+'/randomchoose/result/'+str(i)+'/best.pth',
                                help='Path to trained model weights')
            parser.add_argument('--num-classes', default=8, type=int, help='Number of classes (excluding background)')
