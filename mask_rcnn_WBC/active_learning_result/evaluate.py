...
def eval(args):
    ...
    # 创建模型并加载权重
    model = create_model_eval(num_classes=args.num_classes + 1)  # num_classes 包括背景
...
# parser.add_argument('--weights', default='D:\work\Active_learning\mask_rcnn/run_result/active/11/best.pth', help='Path to trained model weights')
