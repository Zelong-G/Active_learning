...
if __name__ == "__main__":
    ...
    for i in range (1,7):
        ...
        9. 训练
        '''
        data_folder = "/active-learning-4-cell6"
        output_folder = "run_result/active7/"+str(i)
        if i == 1:
            #1. 数据划分
            from WBC_Dataset.数据处理 import process_multiple_datasets,split_cell_images
            data_dir = r'D:\work\Active_learning\mask_rcnn\WBC_Dataset/active-learning-4-cell1\4-cell-data'
        ...
        #5. 选top10
        from active_learning_result.选取top10不确定 import process_and_copy_files,create_coco_annotations
