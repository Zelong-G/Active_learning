...
if __name__ == "__main__":
    ...
    for j in range(5,6):
        ...
        for i in range(2,7):
            source_folder = 'active-learning-4-cell'+str(j)
            out_folder = 'active'+str(j+1)


            source_image_folder = r"D:\work\Active_learning\mask_rcnn\WBC_Dataset\\"+source_folder+"\improve"
            base_target_folder = r"D:\work\Active_learning\mask_rcnn\WBC_Dataset\\"+source_folder+r"\randomchoose\train2017"
            num_total = 20*(i-1)
            ...
            # 示例调用
            train2017_folder = r"D:\work\Active_learning\mask_rcnn\WBC_Dataset\\"+source_folder+r"\randomchoose\train2017"
            trainlabel_folder = r"D:\work\Active_learning\mask_rcnn\WBC_Dataset\masks"
            output_json = r'D:\work\Active_learning\mask_rcnn\WBC_Dataset\\'+source_folder+r'\randomchoose\annotations\instances_train2017.json'
            categories = {
                "LYT": 1,
                "MON": 2,
                "MYO": 3,
            ...
            output_folder = "run_result/"+out_folder+"/"+str(i)+'random_com'
            '''修改文件路径'''
            ...
            # 训练数据集的根目录
            parser.add_argument('--data-path', default='WBC_Dataset/'+source_folder+r'/randomchoose', help='dataset')
            # 检测目标类别数(不包含背景)
            ...
            parser_eval.add_argument('--data-path',
                                default=r'D:\work\Active_learning\mask_rcnn\WBC_Dataset\\'+source_folder,
